...
import voidutilities.tree.IntInsnNode;
...
public class XRayTransformer extends Injector {
	...
	public void inject(ClassReader classReader, ClassNode classNode) {
		for (MethodNode methodNode : (List<MethodNode>) classNode.methods) {// Block class�nda shouldsideberendered
																			// methodu
			if ((classNode.name.contains(ClassNames.getNameIndex(ClassNames.block))
					&& methodNode.name.equals(ClassNames.shouldSideBeRendered))
					&& methodNode.desc.equals("(L" + ClassNames.iblockaccess + ";Lnet/minecraft/BlockPos;L"
							+ ClassNames.enumfacing + ";)Z")) {

				InsnList insnList = new InsnList();

				insnList.add(new MethodInsnNode(INVOKESTATIC, ClassNames.minecraft, ClassNames.getMinecraft,
						"()" + ClassNames.getDesc(ClassNames.minecraft), false)); // buras� ambient oclliosunu 0
																					// yap�yor
				insnList.add(new FieldInsnNode(GETFIELD, ClassNames.minecraft, ClassNames.mcGameSettings,
						ClassNames.getDesc(ClassNames.gamesettings)));
				insnList.add(new InsnNode(ICONST_0));
				insnList.add(new FieldInsnNode(PUTFIELD, ClassNames.gamesettings, ClassNames.ambientOcclusion, "I"));
				insnList.add(new InsnNode(ICONST_1)); // buras� return true
				insnList.add(new InsnNode(IRETURN)); // buras� return true
				...
				insnList.add(new MethodInsnNode(INVOKESTATIC, ClassNames.minecraft, ClassNames.getMinecraft,
						"()" + ClassNames.getDesc(ClassNames.minecraft), false)); // buras� ambient oclliosunu 1
																					// yap�yor
				insnList.add(new FieldInsnNode(GETFIELD, ClassNames.minecraft, ClassNames.mcGameSettings,
						ClassNames.getDesc(ClassNames.gamesettings)));
				insnList.add(new InsnNode(ICONST_1));
				insnList.add(new FieldInsnNode(PUTFIELD, ClassNames.gamesettings, ClassNames.ambientOcclusion, "I"));
				insnList.add(new InsnNode(ICONST_0)); // buras� return false
				insnList.add(new InsnNode(IRETURN)); // buras� return false
				methodNode.instructions.insert(insnList);

				AbstractInsnNode ain = null;
				AbstractInsnNode ainD = null;// 129
				...
				ifpartD.add(new MethodInsnNode(INVOKESTATIC, ClassNames.block, ClassNames.getBlockByID,
						"(I)" + ClassNames.getDesc(ClassNames.block), false));
				ifpartD.add(new VarInsnNode(ALOAD, 0));// block idlerine g�re a��a��dakilerde ayn�
				...
				ifpart.add(new MethodInsnNode(INVOKESTATIC, ClassNames.block, ClassNames.getBlockByID,
						"(I)" + ClassNames.getDesc(ClassNames.block), false));
				...
				ifpartE.add(new MethodInsnNode(INVOKESTATIC, ClassNames.block, ClassNames.getBlockByID,
						"(I)" + ClassNames.getDesc(ClassNames.block), false));
				...
				ifpartF.add(new MethodInsnNode(INVOKESTATIC, ClassNames.block, ClassNames.getBlockByID,
						"(I)" + ClassNames.getDesc(ClassNames.block), false));
				...
				ifpartG.add(new MethodInsnNode(INVOKESTATIC, ClassNames.block, ClassNames.getBlockByID,
						"(I)" + ClassNames.getDesc(ClassNames.block), false));
				...
				ifpart1.add(new MethodInsnNode(INVOKESTATIC, "joptsimple/internal/dev/sabo/module/mods/XRay", "getStatus", "()Z", false));
